...
echo "ContentPath directory: $contentspath"

cps="$contentspath/weasis/weasis-launcher.jar:$contentspath/weasis/felix.jar:$contentspath/weasis/substance.jar"
# Launch
$JAVACMD $DEFAULT_JVM_OPTIONS"$GOSH_ARGS" -Xdock:name=Weasis -Xdock:icon="$resourcespath/logo-button.icns" -Dapple.laf.useScreenMenuBar=true -Dweasis.portable.dir="$contentspath" -classpath "$cps" org.weasis.launcher.WeasisLauncher \$dicom:get --portable ${userParameters[@]}